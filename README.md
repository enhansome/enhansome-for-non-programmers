...
Inspired by [Awesome First Pull Request Opportunities](https://github.com/MunGell/awesome-for-beginners/) ⭐ 88,475 | 🐛 142 | 📅 2026-07-25.

## The projects

These are projects and lists of projects you can contribue to.

* [LanguageTool](https://github.com/languagetool-org/languagetool) ⭐ 14,821 | 🐛 2,145 | 🌐 Java | 📅 2026-08-18: [LanguageTool](https://community.languagetool.org/) is an Open Source proofreading tool.
* [Owncast](https://github.com/owncast/owncast) ⭐ 11,466 | 🐛 174 | 🌐 Go | 📅 2026-08-17: A self-hosted livestreaming video and chat server that allows you to build experiences similar, but not limited to, big tech owned services. A great project for those interested in design, media, documentation, tutorials or community engagement.
* [Oppia](https://github.com/oppia/oppia/wiki/Teaching-with-Oppia) ⭐ 6,771 | 🐛 1,804 | 🌐 Python | 📅 2026-08-17: [Oppia](https://www.oppia.org) is an online learning tool that enables anyone to easily create and share interactive activities.
...
* [List of all the awesome lists](https://github.com/szabgab/awesome-lists) ⭐ 441 | 🐛 0 | 🌐 Perl | 📅 2026-07-29 - A collection of URLs. Excellent way to send your first pull-request.
...
* [First Contributions](https://github.com/firstcontributions/first-contributions) ⭐ 55,540 | 🐛 182 | 📅 2026-08-18: Quick guide on forks, pull requests and contributions.
* [A-to-Z-Resources-for-Students](https://github.com/dipakkr/A-to-Z-Resources-for-Students) ⭐ 22,179 | 🐛 44 | 📅 2026-06-17: This is a dynamic list for everything you need to know for coders and non-coders. Make yourself comfortable updating the list and using any of the resources listed.
