...
Inspired by [Awesome First Pull Request Opportunities](https://github.com/MunGell/awesome-for-beginners/) ⭐ 88,632 | 🐛 146 | 📅 2026-07-25.

## The projects

These are projects and lists of projects you can contribue to.

* [LanguageTool](https://github.com/languagetool-org/languagetool) ⭐ 14,853 | 🐛 2,149 | 🌐 Java | 📅 2026-08-23: [LanguageTool](https://community.languagetool.org/) is an Open Source proofreading tool.
* [Owncast](https://github.com/owncast/owncast) ⭐ 11,469 | 🐛 178 | 🌐 Go | 📅 2026-08-22: A self-hosted livestreaming video and chat server that allows you to build experiences similar, but not limited to, big tech owned services. A great project for those interested in design, media, documentation, tutorials or community engagement.
* [Oppia](https://github.com/oppia/oppia/wiki/Teaching-with-Oppia) ⭐ 6,776 | 🐛 1,811 | 🌐 Python | 📅 2026-08-23: [Oppia](https://www.oppia.org) is an online learning tool that enables anyone to easily create and share interactive activities.
* [Awesome App Ideas](https://github.com/tastejs/awesome-app-ideas) ⭐ 5,636 | 🐛 130 | 📅 2024-06-06: A list of app ideas. You can add your own app ideas. Non-Programmers can create app ideas for programmers looking through the list to solve.
...
* [Cloud Native Glossary](https://github.com/cncf/glossary/blob/main/CONTRIBUTING.md) ⭐ 723 | 🐛 209 | 🌐 HTML | 📅 2026-08-19: [CNCF Glossary](https://glossary.cncf.io) explains cloud-native concepts and the terminologies involved in that ecosystem in simple language and does not require any prior technical background to grasp them. Individuals can start contributing to it by localizing/translating or modifying current terms or proposing new terms.
* [LaTeX Gboard Dictionary](https://github.com/DenverCoder1/LaTeX-Gboard-Dictionary/issues/5) ⭐ 522 | 🐛 7 | 📅 2025-06-03: ⌨ Add shortcuts to a Gboard dictionary to allow Unicode to be typed with simple shortcuts on Android ⚡.
...
* [List of all the awesome lists](https://github.com/szabgab/awesome-lists) ⭐ 447 | 🐛 0 | 🌐 Perl | 📅 2026-07-29 - A collection of URLs. Excellent way to send your first pull-request.
...
* [AI Language Partner](https://github.com/duct-tape2/ai-language-partner/blob/main/docs/community/CONTRIBUTOR_LANDING.md) ⭐ 7 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-20: Local-first Japanese speaking practice app for Korean learners. Non-programmers can improve Korean/Japanese docs, review beginner dialogue naturalness, and add learner notes through [first-timers-only issues](https://github.com/duct-tape2/ai-language-partner/labels/first-timers-only) ⭐ 7 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-20.
...
* [First Contributions](https://github.com/firstcontributions/first-contributions) ⭐ 55,633 | 🐛 100 | 📅 2026-08-23: Quick guide on forks, pull requests and contributions.
* [A-to-Z-Resources-for-Students](https://github.com/dipakkr/A-to-Z-Resources-for-Students) ⭐ 22,202 | 🐛 44 | 📅 2026-06-17: This is a dynamic list for everything you need to know for coders and non-coders. Make yourself comfortable updating the list and using any of the resources listed.
* [Flexbox Froggy](https://github.com/thomaspark/flexboxfroggy) ⭐ 7,377 | 🐛 48 | 🌐 JavaScript | 📅 2026-01-04: Learn CSS Flexbox while playing!
* [awesome-eli5](https://github.com/swapagarwal/awesome-eli5) ⭐ 452 | 🐛 47 | 📅 2023-10-26: 👶 Tech explained like you're five!
...
* [awesome-inspiration](https://github.com/swapagarwal/awesome-inspiration) ⭐ 297 | 🐛 38 | 📅 2024-07-02: 🔥 A curated list of content worth sharing to help you get inspired! ⚡️.
* [GitHub for Non-Programmers](https://github.com/tvanantwerp/github-for-non-programmers) ⭐ 202 | 🐛 10 | 🌐 CSS | 📅 2024-08-12: Guide on using GitHub for workflows other than programming.
