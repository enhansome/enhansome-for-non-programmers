...
Inspired by [Awesome First Pull Request Opportunities](https://github.com/MunGell/awesome-for-beginners/) ⭐ 88,423 | 🐛 141 | 📅 2026-07-25.

## The projects

These are projects and lists of projects you can contribue to.

* [LanguageTool](https://github.com/languagetool-org/languagetool) ⭐ 14,813 | 🐛 2,145 | 🌐 Java | 📅 2026-08-16: [LanguageTool](https://community.languagetool.org/) is an Open Source proofreading tool.
* [Owncast](https://github.com/owncast/owncast) ⭐ 11,463 | 🐛 173 | 🌐 Go | 📅 2026-08-16: A self-hosted livestreaming video and chat server that allows you to build experiences similar, but not limited to, big tech owned services. A great project for those interested in design, media, documentation, tutorials or community engagement.
* [Oppia](https://github.com/oppia/oppia/wiki/Teaching-with-Oppia) ⭐ 6,770 | 🐛 1,806 | 🌐 Python | 📅 2026-08-16: [Oppia](https://www.oppia.org) is an online learning tool that enables anyone to easily create and share interactive activities.
...
* [Cloud Native Glossary](https://github.com/cncf/glossary/blob/main/CONTRIBUTING.md) ⭐ 722 | 🐛 211 | 🌐 HTML | 📅 2026-08-14: [CNCF Glossary](https://glossary.cncf.io) explains cloud-native concepts and the terminologies involved in that ecosystem in simple language and does not require any prior technical background to grasp them. Individuals can start contributing to it by localizing/translating or modifying current terms or proposing new terms.
...
* [First Contributions](https://github.com/firstcontributions/first-contributions) ⭐ 55,497 | 🐛 172 | 📅 2026-08-16: Quick guide on forks, pull requests and contributions.
* [A-to-Z-Resources-for-Students](https://github.com/dipakkr/A-to-Z-Resources-for-Students) ⭐ 22,169 | 🐛 43 | 📅 2026-06-17: This is a dynamic list for everything you need to know for coders and non-coders. Make yourself comfortable updating the list and using any of the resources listed.
* [Flexbox Froggy](https://github.com/thomaspark/flexboxfroggy) ⭐ 7,375 | 🐛 48 | 🌐 JavaScript | 📅 2026-01-04: Learn CSS Flexbox while playing!
...
* [GitHub for Non-Programmers](https://github.com/tvanantwerp/github-for-non-programmers) ⭐ 199 | 🐛 10 | 🌐 CSS | 📅 2024-08-12: Guide on using GitHub for workflows other than programming.
