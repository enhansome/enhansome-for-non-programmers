...
Inspired by [Awesome First Pull Request Opportunities](https://github.com/MunGell/awesome-for-beginners/) ⭐ 88,399 | 🐛 140 | 📅 2026-07-25.

## The projects

These are projects and lists of projects you can contribue to.

* [LanguageTool](https://github.com/languagetool-org/languagetool) ⭐ 14,808 | 🐛 2,145 | 🌐 Java | 📅 2026-08-14: [LanguageTool](https://community.languagetool.org/) is an Open Source proofreading tool.
* [Owncast](https://github.com/owncast/owncast) ⭐ 11,464 | 🐛 174 | 🌐 Go | 📅 2026-08-14: A self-hosted livestreaming video and chat server that allows you to build experiences similar, but not limited to, big tech owned services. A great project for those interested in design, media, documentation, tutorials or community engagement.
* [Oppia](https://github.com/oppia/oppia/wiki/Teaching-with-Oppia) ⭐ 6,767 | 🐛 1,808 | 🌐 Python | 📅 2026-08-15: [Oppia](https://www.oppia.org) is an online learning tool that enables anyone to easily create and share interactive activities.
* [Awesome App Ideas](https://github.com/tastejs/awesome-app-ideas) ⭐ 5,631 | 🐛 130 | 📅 2024-06-06: A list of app ideas. You can add your own app ideas. Non-Programmers can create app ideas for programmers looking through the list to solve.
...
* [The Sourdough Framework](https://github.com/hendricius/the-sourdough-framework) ⭐ 3,612 | 🐛 23 | 🌐 TeX | 📅 2026-06-05: An opportunity to share your bread / sourdough recipes!
* [The Turing Way](https://github.com/alan-turing-institute/the-turing-way) ⭐ 2,168 | 🐛 611 | 🌐 TeX | 📅 2026-08-13: A series of open source guides about data science and AI. Contributors can add to new and ongoing chapters, work on translation efforts, contribute to infrastructure maintenance work within the project, and more.
...
* [Cloud Native Glossary](https://github.com/cncf/glossary/blob/main/CONTRIBUTING.md) ⭐ 721 | 🐛 210 | 🌐 HTML | 📅 2026-08-14: [CNCF Glossary](https://glossary.cncf.io) explains cloud-native concepts and the terminologies involved in that ecosystem in simple language and does not require any prior technical background to grasp them. Individuals can start contributing to it by localizing/translating or modifying current terms or proposing new terms.
...
* [List of all the awesome lists](https://github.com/szabgab/awesome-lists) ⭐ 440 | 🐛 0 | 🌐 Perl | 📅 2026-07-29 - A collection of URLs. Excellent way to send your first pull-request.
...
* [CheatSheets](https://github.com/Jahenr/CheatSheets) ⭐ 119 | 🐛 3 | 📅 2025-10-12: Cheat sheet documentation project that allows contributors to add and reference most common commands for systems we know and love in a single place.
...
* [AI Language Partner](https://github.com/duct-tape2/ai-language-partner/blob/main/docs/community/CONTRIBUTOR_LANDING.md) ⭐ 7 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-13: Local-first Japanese speaking practice app for Korean learners. Non-programmers can improve Korean/Japanese docs, review beginner dialogue naturalness, and add learner notes through [first-timers-only issues](https://github.com/duct-tape2/ai-language-partner/labels/first-timers-only) ⭐ 7 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-13.
...
* [First Contributions](https://github.com/firstcontributions/first-contributions) ⭐ 55,487 | 🐛 180 | 📅 2026-08-15: Quick guide on forks, pull requests and contributions.
* [A-to-Z-Resources-for-Students](https://github.com/dipakkr/A-to-Z-Resources-for-Students) ⭐ 22,164 | 🐛 43 | 📅 2026-06-17: This is a dynamic list for everything you need to know for coders and non-coders. Make yourself comfortable updating the list and using any of the resources listed.
* [Flexbox Froggy](https://github.com/thomaspark/flexboxfroggy) ⭐ 7,376 | 🐛 48 | 🌐 JavaScript | 📅 2026-01-04: Learn CSS Flexbox while playing!
* [awesome-eli5](https://github.com/swapagarwal/awesome-eli5) ⭐ 449 | 🐛 47 | 📅 2023-10-26: 👶 Tech explained like you're five!
...
* [GitHub for Non-Programmers](https://github.com/tvanantwerp/github-for-non-programmers) ⭐ 198 | 🐛 10 | 🌐 CSS | 📅 2024-08-12: Guide on using GitHub for workflows other than programming.
* [DX Knowledge Base](https://github.com/DXHeroes/knowledge-base-content) ⭐ 150 | 🐛 61 | 🌐 TypeScript | 📅 2025-11-03: Open source Knowledge Base filled with articles about Developer Experience and related topics like software creation process and team management.
* [Basic Github commands](https://github.com/LiviaGitHub/basic-github-commands) ⭐ 22 | 🐛 0 | 📅 2022-11-09: This repository serves as a comprehensive guide to the fundamental commands of Git. Whether you are a beginner or looking to refresh your knowledge, this repository provides clear explanations and practical examples of essential Git commands. Contributors can enhance this project by adding new chapters or expanding ongoing ones, working on translation efforts to make the content accessible to a broader audience, providing feedback and suggestions for better documentation.
