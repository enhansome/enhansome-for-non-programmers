...
Inspired by [Awesome First Pull Request Opportunities](https://github.com/MunGell/awesome-for-beginners/) ⭐ 88,816 | 🐛 148 | 📅 2026-07-25.

## The projects

These are projects and lists of projects you can contribue to.

* [LanguageTool](https://github.com/languagetool-org/languagetool) ⭐ 14,888 | 🐛 2,147 | 🌐 Java | 📅 2026-08-28: [LanguageTool](https://community.languagetool.org/) is an Open Source proofreading tool.
* [Owncast](https://github.com/owncast/owncast) ⭐ 11,478 | 🐛 173 | 🌐 Go | 📅 2026-08-29: A self-hosted livestreaming video and chat server that allows you to build experiences similar, but not limited to, big tech owned services. A great project for those interested in design, media, documentation, tutorials or community engagement.
* [Oppia](https://github.com/oppia/oppia/wiki/Teaching-with-Oppia) ⭐ 6,784 | 🐛 1,807 | 🌐 Python | 📅 2026-08-29: [Oppia](https://www.oppia.org) is an online learning tool that enables anyone to easily create and share interactive activities.
...
* [Cloud Native Glossary](https://github.com/cncf/glossary/blob/main/CONTRIBUTING.md) ⭐ 724 | 🐛 207 | 🌐 HTML | 📅 2026-08-26: [CNCF Glossary](https://glossary.cncf.io) explains cloud-native concepts and the terminologies involved in that ecosystem in simple language and does not require any prior technical background to grasp them. Individuals can start contributing to it by localizing/translating or modifying current terms or proposing new terms.
...
* [First Contributions](https://github.com/firstcontributions/first-contributions) ⭐ 55,732 | 🐛 152 | 📅 2026-08-29: Quick guide on forks, pull requests and contributions.
* [A-to-Z-Resources-for-Students](https://github.com/dipakkr/A-to-Z-Resources-for-Students) ⭐ 22,214 | 🐛 44 | 📅 2026-06-17: This is a dynamic list for everything you need to know for coders and non-coders. Make yourself comfortable updating the list and using any of the resources listed.
